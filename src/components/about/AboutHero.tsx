      ...
      <div className="relative w-32 h-32 flex items-center justify-center">
        ...
        <div className="relative z-10">
          <svg width="80" height="80" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              d="M30 20 L30 80 L40 80 L40 55 L55 55 L70 80 L82 80 L65 53 C 72 50 78 43 78 33 C 78 20 68 20 60 20 Z M40 30 L58 30 C 63 30 68 32 68 38 C 68 44 63 46 58 46 L40 46 Z"
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex min-h-screen items-center">
        <div className="mx-auto max-w-6xl px-6 lg:px-8 py-16 w-full mt-30">
          <div className="mx-auto max-w-4xl text-center flex flex-col items-center">
            {/* Logo at top */}
            <div className="mb-10">
              <img src="/agency_logo.png" alt="dev365" className="h-15 lg:h-30 w-auto" />
            </div>

            {/* Main Headline */}
            <h1 className="mb-6 text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl leading-tight">
            ...
            {/* Sub-headline */}
            <p className="text-lg leading-relaxed text-white/60 sm:text-xl max-w-3xl mx-auto font-light">
              From design and development to hosting, updates, and support —
            </p>
            <p className="text-lg leading-relaxed text-white/60 sm:text-xl max-w-3xl mx-auto font-light">
              We take complete ownership of your website through a simple monthly subscription.
            </p>
          </div>
        </div>
      </div>
